...
<body style= 'margin-left:3%; margin-bottom:3%;'>
	...
	<div class='row card'>
		...
		<?php echo utf8_decode($row['NAME']);?><br/>
...
<!--NOTES-->
	...
	<div class="row card" style="padding-top: 1%; padding-bottom: 1%;">
		...
		<button style='position: fixed; bottom: 20px; right: 20px;' onclick='window.print();' class='btn btn-raised pull-right hidden-print btn-info'><i class='fa fa-print'></i> Print</button>
	</div>
