...
<head>
	...
	if(isset($_GET['iNt3RvI3w3r'])){
		...
		echo'$("textarea").prop("disabled", false);';
...
error_reporting(0);
	...
	while($row = $resultS->fetch_assoc()){
		$position = $row["POSITION"];
		 ...
		 $emphone1 = $row["1.5 Emp_phone"];
		 $emphone2 = $row["2.5 Emp_phone"];
		 $emphone3 = $row["3.5 Emp_phone"];
		 $emphone4 = $row["4.5 Emp_phone"];
		 $emphone5 = $row["5.5 Emp_phone"];
	  ...
	  <div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h3 class="modal-title"><center>Interview Result</center></h3>
			</div>
		  ...
		  <div class="modal-footer">
			  ...
			  <button id="submitInterviewForm" class="btn btn-success btn-raised">Submit</button>
		  </div>
		</div>
	  </div>
	</div>
	...
	<div id="questionModal" class="modal fade" role="dialog">
	  <div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
				<h3 class="modal-title"><center>Questions</center></h3>
			</div>
			<div class="modal-body">
			<div class="container">
		    ...
		    <div class="panel panel-default">
		      <div class="panel-heading">
		        <h4 class="panel-title">
		          <a data-toggle="collapse" data-parent="#accordion" href="#q1">1.	What experience do you have in a call center?</a>
		        </h4>
		      </div>
		      <div id="q1" class="panel-collapse collapse in">
		        <div class="panel-body"><textarea class="form-control" rows="5" name="q1" id="q1"></textarea></div>
		      </div>
		    </div>
		    <div class="panel panel-default">
		      <div class="panel-heading">
		        <h4 class="panel-title">
		          <a data-toggle="collapse" data-parent="#accordion" href="#q2">2.	How do you handle the pressure at work?</a>
		        </h4>
		      </div>
		      <div id="q2" class="panel-collapse collapse">
		        <div class="panel-body"><textarea class="form-control" rows="5" name="q2" id="q2"></textarea></div>
		      </div>
		    </div>
		    <div class="panel panel-default">
		      <div class="panel-heading">
		        <h4 class="panel-title">
		          <a data-toggle="collapse" data-parent="#accordion" href="#q3">3.	What are your strengths as an agent?</a>
		        </h4>
		      </div>
		      <div id="q3" class="panel-collapse collapse">
		        <div class="panel-body"><textarea class="form-control" rows="5" name="q3" id="q3"></textarea></div>
		      </div>
		    </div>
		    <div class="panel panel-default">
		      <div class="panel-heading">
		        <h4 class="panel-title">
		          <a data-toggle="collapse" data-parent="#accordion" href="#q4">4.	Can you explain in your own words, what Customer Satisfaction is?</a>
		        </h4>
		      </div>
		      <div id="q4" class="panel-collapse collapse">
		        <div class="panel-body"><textarea class="form-control" rows="5" name="q4" id="q4"></textarea></div>
		      </div>
		    </div>
		    <div class="panel panel-default">
		      <div class="panel-heading">
		        <h4 class="panel-title">
		          <a data-toggle="collapse" data-parent="#accordion" href="#q5">5.	What is the key to success for a call center agent?</a>
		        </h4>
		      </div>
		      <div id="q5" class="panel-collapse collapse">
		        <div class="panel-body"><textarea class="form-control" rows="5" name="q5" id="q5"></textarea></div>
		      </div>
		    </div>
		    <div class="panel panel-default">
		      <div class="panel-heading">
		        <h4 class="panel-title">
		          <a data-toggle="collapse" data-parent="#accordion" href="#q6">6.	Do you like mutli-tasking, or you prefer to tackle one problem at a time? </a>
		        </h4>
		      </div>
		      <div id="q6" class="panel-collapse collapse">
		        <div class="panel-body"><textarea class="form-control" rows="5" name="q6" id="q6"></textarea></div>
		      </div>
		    </div>
		    <div class="panel panel-default">
		      <div class="panel-heading">
		        <h4 class="panel-title">
		          <a data-toggle="collapse" data-parent="#accordion" href="#q7">7.	What will you do in a situation when your system shuts down and you are still on the phone with a customer?</a>
		        </h4>
		      </div>
		      <div id="q7" class="panel-collapse collapse">
		        <div class="panel-body"><textarea class="form-control" rows="5" name="q7" id="q7"></textarea></div>
		      </div>
		    </div>
...
<div style="display: <?php if(isset($_GET['iNt3RvI3w3r']))echo"block";else echo"none";?>;">
	<div class="row">
		<div class="col-md-1"></div>
			<div class="form-group">
			<div class="col-md-12">
				<button type="button" data-toggle="modal" data-target="#questionModal" id="interviewButton" class="btn btn-info btn-lg pull-left">Questions</button>
			</div>
		</div>
	</div>	
</div><br></div>
...
<!--questions end-->	
				...
				</div></div></div> <!-- End of container 2 -->
		...
		<div class="col-md-1"></div>
			...
			<div class="col-md-12">
				<button type="button" data-toggle="modal" data-target="#questionModal" id="interviewButton" class="btn btn-info btn-lg pull-left">Questions</button>
					...
					<button type="button" style="margin-bottom: 1%" class="btn btn-raised btn-primary pull-right" onclick="document.getElementById('container3').style.display='none'; document.getElementById('container4').style.display='block';">NEXT</button></div></div>	
...
<!--questions end-->	
                    ...
                    <button type="button" style="margin-bottom: 1%" class="btn btn-raised btn-primary pull-right" id="frnext">NEXT</button></div></div>
...
<!--questions end-->	
                	...
                	<div class="row ">
					<div class="col-md-12">
                	<button type="button" class="btn btn-raised btn-primary pull-left" onclick="document.getElementById('container4').style.display='block';document.getElementById('container5').style.display='none';">PREVIOUS</button></div>
					<?php
					if(isset($_GET['iNt3RvI3w3r'])){
								...
								if($get_ans->num_rows > 0){
									while($row5 = $get_ans->fetch_assoc()) {
										...
										<div class="form-group label-floating">
											  ...
											  <textarea class="form-control" rows="5" name="question'.$cnt.'" id="question'.$cnt.'" required>'.$answer.'</textarea>
